    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3'>
        <div className='flex flex-col w-full'>
          ...
          className='px-3 py-2 mt-1 border border-gray-200 rounded-md outline-none'
          value={car.year} onChange={e=> setCar({...car,
           year:e.target.value})}/>
        </div>
        <div className='flex flex-col w-full'>
          ...
          className='px-3 py-2 mt-1 border border-gray-200 rounded-md outline-none'
          value={car.pricePerDay} onChange={e=> setCar({...car,
           pricePerDay:e.target.value})}/>
        </div>
        <div className='flex flex-col w-full'>
          <label>Category</label>
          <select onChange={e=>setCar({...car, category: e.target.value})}
            value={car.category} className='px-3 py-2 mt-1 border border-gray-200
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3'>
                ...
                <div className='flex flex-col w-full'>
                  ...
                  <select onChange={e=>setCar({...car, transmission: e.target.value})}
                    value={car.transmission} className='px-3 py-2 mt-1 border border-gray-200
                    rounded-md outline-none'>
                ...
                <div className='flex flex-col w-full'>
                  ...
                  <select onChange={e=>setCar({...car, fuel_type: e.target.value})}
                    value={car.fuel_type} className='px-3 py-2 mt-1 border border-gray-200
                    rounded-md outline-none'>
            ...
            <div className='flex flex-col w-full'>
                <label>Location</label>
                  <select onChange={e=>setCar({...car, location: e.target.value})}
                    value={car.location} className='px-3 py-2 mt-1 border border-gray-200
                    rounded-md outline-none'>
                    <option value="">Select a location</option>
                    <option value="New York">New York</option>
                    <option value="Los Angelse">Los Angelse"</option>
              ...
              <div className='flex flex-col w-full'>
                ...
                className='px-3 py-2 mt-1 border border-gray-200 rounded-md outline-none'
                value={car.description} onChange={e=> setCar({...car,
